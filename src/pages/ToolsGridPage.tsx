  ...
  return (
    <div className="min-h-screen bg-bg text-text pb-32">
      ...
      <div className="p-6 flex items-center gap-4 mb-4">
        <button 
          onClick={() => nav(-1)}
          className="w-10 h-10 rounded-full elite-glass border-white/10 flex items-center justify-center text-text-dim hover:text-primary transition-colors spatial-card"
        >
          <FaArrowLeft />
        </button>
        <div>
